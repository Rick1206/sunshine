package code.page.game {
	...
	public class mcCategory extends MovieClip {
		...
		public function onSelect():void {
			...
			TweenMax.to(sImg, .3, { autoAlpha:1} );
			
			TweenMax.to(txtTitle, .3, { colorTransform: { tint:0xC54A26, tintAmount:1 }} );
		}
		
		public function unSelect():void {
			
			TweenMax.to(sImg, .3, { autoAlpha:0} );
			
			TweenMax.to(txtTitle, .3, { colorTransform: { tint:0x99783F, tintAmount:1 }} );
		}
