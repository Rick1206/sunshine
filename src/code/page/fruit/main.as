package code.page.fruit
{
	...
	public class main extends MovieClip
	{
		...
		private function init(e:Event = null):void
		{
			...
			var cfg:LoadXml = new LoadXml(GlobalVars.getPath() + "xml/fruit.xml" + GlobalVars.getVer(), onLoadedHandler);
		...
		private function onLoadedHandler(e:Event):void
		{
			...
			var num:int = _xmlDate.fruit.length();
			...
			{
				var sc:mcFruit = new mcFruit();
				
				//trace(_xmlDate.fruit[i].type);
				//switch(String(_xmlDate.fruit[i].type)) {
					//case "2":
						//sc.setPicRef(-40, 100);
						//break;
					//case "3":
				...
				//}
				//
				//sc.loadInfo(_xmlDate.fruit[i].title, GlobalVars.getPath() + _xmlDate.fruit[i].img + GlobalVars.getVer(), _xmlDate.fruit[i].type);
