package code.page.brand
{
	...
	public class nutMain extends MovieClip
	{
		...
		public function runR():void {
			...
			var sc:mcPro = proArrR[len-1].clone();
		...
		private function runL():void 
		{
			...
			var sc:mcPro = proArrL[len].clone();
			trace(sc);
			sc.y = posArrL[0].y;
			sc.x = posArrL[0].x;
			sc.alpha = 0;
