package code.tool
{
	...
	public class ScrollBar
	{
		...
		*/  
		public function ScrollBar($target:DisplayObjectContainer, $maskTarget:*, $scrollBar:MovieClip, $scrollLine:Sprite, $tween:Number = 5, $elastic:Boolean = false, $lineAbleClick:Boolean = false , $mouseWheel:Boolean = false, $direction:String = "L") 
		{
